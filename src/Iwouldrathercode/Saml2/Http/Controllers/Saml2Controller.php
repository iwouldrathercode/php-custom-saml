...
namespace Iwouldrathercode\Saml2\Http\Controllers;

use Iwouldrathercode\Saml2\Events\Saml2LoginEvent;
...
class Saml2Controller extends Controller
{
    ...
    public function acs(Saml2Auth $saml2Auth, $idpName)
    {
        ...
        */
        ...
        if ($redirectUrl !== null) {
            return redirect(route($redirectUrl, ['id' => $user->getUserId()]));
        } else {

            return redirect(route(config('saml2_settings.loginRoute'), ['id' => $user->getUserId()]));
        }
    }
